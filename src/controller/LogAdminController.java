...
public class LogAdminController {
    ...
    // @PostMapping("/login")
    // public String login(@RequestParam String adminUser, @RequestParam String adminPass) {
    //     if (logAdminService.login(adminUser, adminPass)) {
    //         return "redirect:/admin/nasabahlist"; // Redirect ke halaman daftar nasabah
    //     } else {
